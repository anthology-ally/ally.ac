...
(function () {
    ...
    function loadData() {
        $.getJSON("https://performance-us-east-1-gaadstack-allygaad5a670049-141o6wjvy80ts.s3.amazonaws.com/clients2023.json", {_: new Date().getTime()}).done(function (results) {
            $.getJSON("https://performance-us-east-1-gaadstack-allygaad5a670049-141o6wjvy80ts.s3.amazonaws.com/gaad-fte2023.json", {_: new Date().getTime()}).done(function (response) {
    ...
    function loadGraph() {
        ...
        $.getJSON("https://performance-us-east-1-gaadstack-allygaad5a670049-141o6wjvy80ts.s3.amazonaws.com/totals2023.json", {_: new Date().getTime()}).done(function (response) {
            var labels = [];
            var points = [];
            var last = 0;
