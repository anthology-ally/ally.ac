(function () {
    ...
    function loadGraph() {
        ...
        $.getJSON("https://performance-us-east-1-gaadstack-allygaad5a670049-141o6wjvy80ts.s3.amazonaws.com/totals.json", {_: new Date().getTime()}).done(function (response) {
            ...
            showConfetti(last, 100000, 108546, 'confetti_2023_100k', 'Wow! We fixed 100,000 files!');
            showConfetti(last, 110248, 200000, 'confetti_2023_2022', 'Wow! We beat the last year\'s record!');
